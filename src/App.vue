<template>
  <div class="container">
    <div class="graph">
      <div class="col">
        <h1 class="text-center">USA COVID-19 DATA</h1>
      </div>
    </div>

    <div class="graph" v-if="arrPositive.length>0">
      <div class="col">
    ...
    <div class="graph" v-if="arrHospitalized.length>0">
      <div class="col">
    ...
    <div class="graph" v-if="arrInIcu.length>0">
      <div class="col">
    ...
    <div class="graph" v-if="arrOnVentilators.length>0">
      <div class="col">
    ...
    <div class="graph" v-if="arrRecovered.length>0">
      <div class="col">
    ...
    <div class="graph" v-if="arrDeaths.length>0">
      <div class="col">
